...
void write_analysis(std::ostream& out, const std::string& name, 
                    ...
                    const vector<Student_info>& didnt){
                        out << name << ": median(did) =" << analysis(did, choose) <<
                                       ": median(didnt) = " << analysis(didnt, choose) << endl;
                    }

vector<Student_info> classify(vector<Student_info>& students, bool criteria(const Student_info& )){
